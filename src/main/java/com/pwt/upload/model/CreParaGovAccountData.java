...
@Entity
@Table(name = "MS_BOB_CDU_ACCT_DTLS_CON" , schema = "AAA_BDL")
public class CreParaGovAccountData {
...
//	@JsonFormat(pattern="YYYY-MM-DD")
	...
	public CreParaGovAccountData(String id, String customerName, int outstandingAmt, int overdue, String customerId,
			String schemeCode, String solId, String sanctionDate, String limit, String overduesSince, String roi,
			String assetClass, String descOfActivity, String zone, String region, String branchName, String schemeDesc,
			String status, String userId, String dummy, String internalTraining, LocalDate cunDate) {
		super();
		this.id = id;
		this.customerName = customerName;
		this.outstandingAmt = outstandingAmt;
	...
	public CreParaGovAccountData() {
		super();
		// TODO Auto-generated constructor stub
	}
	
//	@Column (name = "CUN_END_DATE")
//	private Date cunEndDate;
