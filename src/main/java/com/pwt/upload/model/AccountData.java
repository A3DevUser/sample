...
public class AccountData {
	...
	public AccountData(String id, String customerName, Date auditDate, int outstandingAmt, int overdue,
			...
			String branchName, String schemeDesc, String status, String userId) {
		super();
		this.id = id;
		this.customerName = customerName;
		this.auditDate = auditDate;
